...
export const currentSlice = createSlice({
  ...
  reducers: {
    ...
    didPrepareTransactionSubmitAlgoSigner: (state, action: PayloadAction<any>) => void (state.algoSigner.accounts = action.payload, state.transactionPage[action.payload.sowCommand] = 4),
