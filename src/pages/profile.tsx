...
import {
  Card, CardBody, CardText, CardTitle, CardSubtitle, ListGroup,
  Container, Collapse, Label, Spinner,
  Col, Row, Jumbotron,
  FormGroup, FormFeedback, ListGroupItem,
...
export const ProfilePage = () => {
  ...
  const [isOpenArbitratorSettings, setIsOpenArbitratorSettings] = React.useState(false);

  const toggleOpenArbitratorSettings = () => setIsOpenArbitratorSettings(!isOpenArbitratorSettings);
  ...
  console.log("in profile myArbitratorSettings: ", myArbitratorSettings)
                ...
                return (
                  <Form>
                    <CardBody>
                      ...
                      <ListGroupItem>
                        <Row data-cy="arbitratorSettingsCollapse" onClick={toggleOpenArbitratorSettings}>
                          <Col className="col-1">
                            <FontAwesomeIcon icon={isOpenArbitratorSettings ? faAngleDown : faAngleRight} size='1x' />
                          </Col>
                          <Col>
                            {myArbitratorSettings ?
                              myArbitratorSettings.requestId && myArbitratorSettings.requestId != "already_approved" ?
                                <CardText>Waiting for approval by Uncommon Creative (request: #{myArbitratorSettings.requestId.substring(0, 5)})</CardText>
                                : <CardText>Change your arbitrator settings</CardText>
                              : <CardText>Apply as arbitrator</CardText>}
                          </Col>
                        </Row>
                        <Collapse isOpen={isOpenArbitratorSettings} className="mt-2">
                        ...
                        <CardSubtitle tag="h6" className="mb-2 text-muted text-center">Change your arbitrator settings</CardSubtitle> */}
                          <Jumbotron>
                            ...
                            <Row>
                              <Col className="col-md-2 col-12">
                                <FormGroup>
                                  ...
                                  <CustomInput data-cy='arbitratorSettingsEnabled' type="switch" name="enabled" id="enabled" tag={Field}
                                    disabled={myArbitratorSettings && myArbitratorSettings.requestId && myArbitratorSettings.requestId != "already_approved"}
                              ...
                              <Col className="col-md-7 col-12 ">
                                <FormGroup>
                                  ...
                                  <InputGroup>
                                    <Input data-cy='arbitratorSettingsFeeFlat' disabled={!switchEnabled || (myArbitratorSettings && myArbitratorSettings.requestId && myArbitratorSettings.requestId != "already_approved")} invalid={errors.feeFlat && touched.feeFlat ? true : false} type="text" name="feeFlat" id="feeFlat" placeholder={"fee flat"} tag={Field} />

                                    <InputGroupButtonDropdown disabled={!switchEnabled || (myArbitratorSettings && myArbitratorSettings.requestId && myArbitratorSettings.requestId != "already_approved")} addonType="append" isOpen={dropdownCurrencyOpen} toggle={toggleDropDownCurrency}>
                              ...
                              <Col className="col-md-3 col-12 ">
                                <FormGroup>
                                  ...
                                  <InputGroup>
                                    <Input data-cy='arbitratorSettingsFeePercentage' disabled={!switchEnabled || (myArbitratorSettings && myArbitratorSettings.requestId && myArbitratorSettings.requestId != "already_approved")} invalid={errors.feePercentage && touched.feePercentage ? true : false} type="text" name="feePercentage" id="feePercentage" placeholder={"fee percentage"} tag={Field} />
                            ...
                            <FormGroup data-cy='arbitratorSettingsTags'>
                              ...
                              <TagsInput disabled={!switchEnabled || (myArbitratorSettings && myArbitratorSettings.requestId && myArbitratorSettings.requestId != "already_approved")} tags={myArbitratorSettings && myArbitratorSettings.tags ? myArbitratorSettings.tags : []} />
